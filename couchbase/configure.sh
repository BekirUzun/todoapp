...
curl -v -u $COUCHBASE_ADMINISTRATOR_USERNAME:$COUCHBASE_ADMINISTRATOR_PASSWORD http://127.0.0.1:8093/query/service -d "statement=CREATE PRIMARY INDEX ON default"
